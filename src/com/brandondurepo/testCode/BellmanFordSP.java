package com.brandondurepo.testCode;
...
public class BellmanFordSP {
    ...
    public static void main(String[] args) {
        ...
        Integer[] labels = new Integer[]{0, 1, 2};
        BigDecimal[][] weights = new BigDecimal[3][3];
        weights[0][1] = new BigDecimal(4.0);
        weights[0][2] = new BigDecimal(2.0);
        weights[1][0] = new BigDecimal(-4.0);
        weights[1][2] = new BigDecimal(-1.0);
        weights[2][0] = new BigDecimal(-2.0);
        weights[2][1] = new BigDecimal(1.0);


        EdgeWeightedDigraph G = new EdgeWeightedDigraph(labels, weights );
//        EdgeWeightedDigraph G = new EdgeWeightedDigraph(3);
//        DirectedEdge a = new DirectedEdge(1,0, -4.0);
//        DirectedEdge b = new DirectedEdge(0,2, 2.0);
//        DirectedEdge c = new DirectedEdge(2,1, 1.0);
//        DirectedEdge d = new DirectedEdge(0,1, 4.0);
//        DirectedEdge e = new DirectedEdge(1,2, -1.0);
//        DirectedEdge f = new DirectedEdge(2,0, -2.0);
//        G.addEdge(a);
//        G.addEdge(b);
//        G.addEdge(c);
//        G.addEdge(d);
...
//        G.addEdge(f);
        ...
        if (sp.hasNegativeCycle()) {
            StdOut.printf("Negative cycle present.\n");
            for (DirectedEdge h : sp.negativeCycle())
                StdOut.println(h);
        }
        ...
        // print shortest paths
            ...
            for (int v = 0; v < G.V(); v++) {
                if (sp.hasPathTo(v)) {
                    StdOut.printf("0 to %d (%5.2f)  ", v, sp.distTo(v));
                    for (DirectedEdge i : sp.pathTo(v)) {
                        StdOut.print(i + "   ");
                    }
                    StdOut.println();
                }
                else {
                    StdOut.printf("0 to %d no path\n",  v);
                }
            }
        }
